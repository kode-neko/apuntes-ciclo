...
hbs_1.default.registerHelper('urlSet', utils_1.urlsHelper);
...
app.use('/assets/docs', express_1.default.static(path_1.default.join(__dirname, '../assets/html')));
// routes
app.use('/', routes_1.pageRouter);
exports.default = app;
